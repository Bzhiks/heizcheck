  ...
  return (
    <div style={{ maxWidth: '560px', margin: '0 auto', padding: '4rem 1.5rem 3rem' }}>
      ...
      <p style={{
        ...
        Kein Anruf, kein Druck, kein Verkaufsgespräch. 5 kurze Fragen — du bekommst Kosten, Förderung und Ersparnis konkret für deine Situation.
      </p>
      <button
        onClick={onStart}
        style={{
      ...
      <div style={{ marginTop: '3rem', padding: '20px', background: '#f8f8f7', borderRadius: '12px' }}>
        ...
        {[
          ...
          <div key={i} style={{ display: 'flex', gap: '10px', fontSize: '13px', color: '#6b6966', padding: '4px 0', alignItems: 'flex-start' }}>
            <span style={{ color: x ? '#E24B4A' : '#1D9E75', flexShrink: 0, marginTop: '1px' }}>{x ? '✕' : '✓'}</span>
            <span>{text}</span>
          </div>
        ))}
      </div>
