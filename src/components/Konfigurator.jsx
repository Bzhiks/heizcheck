    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
        ...
        <div>
          ...
          {option.sub && (
            <div style={{ fontSize: '12px', color: '#a09e9a', marginTop: '2px' }}>{option.sub}</div>
          )}
        </div>
      </div>
      <div style={{
...
export default function Konfigurator({ onFertig }) {
  ...
  return (
    <div style={{
      maxWidth: '520px', margin: '0 auto', padding: '0 1rem',
      opacity: animate ? 1 : 0,
      ...
      {aktuell.typ === 'eingabe' && (
        <div>
          <div style={{ display: 'flex', gap: '10px' }}>
            <input
              ...
              style={{
                ...
                fontSize: '16px', color: '#0a0a0a', background: '#fff',
            ...
            />
            <div style={{
              padding: '14px 16px', border: '1px solid #e2e1de',
              borderRadius: '12px', fontSize: '13px', color: '#a09e9a',
              background: '#f8f8f7', display: 'flex', alignItems: 'center', whiteSpace: 'nowrap'
            }}>
              {aktuell.einheit}
            </div>
          </div>
          ...
          <button
            onClick={() => {
              const neu = { ...antworten, [aktuell.id]: 'default' }
              setAntworten(neu)
              setEingabe('')
